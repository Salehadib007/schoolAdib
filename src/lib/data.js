...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(year, month, day + 2, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(year, month, day + 3, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(year, month, day + 3, 13, 0),
    end: new Date(year, month, day + 3, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(year, month, day + 4, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(year, month, day + 5, 8, 0),
    end: new Date(year, month, day + 5, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(year, month, day + 5, 9, 0),
    end: new Date(year, month, day + 5, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(year, month, day + 5, 11, 0),
    end: new Date(year, month, day + 5, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(year, month, day + 5, 13, 0),
    end: new Date(year, month, day + 5, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(year, month, day + 5, 14, 0),
    end: new Date(year, month, day + 5, 14, 45),
  },
];
